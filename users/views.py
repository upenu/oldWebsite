...
def myprofile(request):
    ...
    wks_gen = gc.open("UPE General Requirements").sheet1
    wks_com = gc.open("UPE General Requirements").worksheet(up.get_committee_display())
    ...
    return render_to_response('users/profile.html', 
            context_instance=RequestContext(request,{'up': up, 'resume_upload': resume_form,
                                                     'profile_pic': profile_pic_form, 'gen_req_tuple': gen_req_tuple,
                                                     'com_req_tuple': com_req_tuple}))
